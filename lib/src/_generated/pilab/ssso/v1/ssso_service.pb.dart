...
class LoginRequest extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(3)
  $core.String get realmId => $_getSZ(2);
  @$pb.TagNumber(3)
  set realmId($core.String v) { $_setString(2, v); }
  @$pb.TagNumber(3)
  $core.bool hasRealmId() => $_has(2);
  @$pb.TagNumber(3)
  void clearRealmId() => clearField(3);
